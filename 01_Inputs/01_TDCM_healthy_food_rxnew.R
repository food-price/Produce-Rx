...
# 0.2 remove all data from memory
rm(list = ls())
...
# 0.6 Model settings (set manually or read from command line when submitted through cluster)
...
#########################################################################
#define simulation function for running n.sim simulations 
...
##run n.sim times of the simulation function in parallel processes, and then combine the results in sim_out
##Run the function for each arm separately 
